...
### <ins>Propositions:</ins> A statement that can be true or false but not both. We can represent these with propositional variables
...
### <ins>Predicates:</ins> Are logical statements or expressions that contain oneor more variables and become a proposition when specific values areassigned to those variables
